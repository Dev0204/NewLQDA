...
import { getCollectionsByChain, getOilCollectionsByChain } from "helpers/collections";
import {
  useMoralis,
  useMoralisQuery,
  useNewMoralisObject,
...
function NFTTokenIds({ inputValue, setInputValue, checked }) {
  const fallbackImg =
  ...
  // const NFTCollections = checked ? getCollectionsByChain(chainId) : getOilCollectionsByChain(chainId);
